export const translations = {
  it: {
    ...
    history: {
      ...
      emptyHistory: "Nessuna esecuzione registrata.",
      filterAll: "Tutte",
      ...
      compareSelectionLabel: (count: number) =>
        count === 1 ? "1 run selezionata" : `${count} run selezionate`,
      resetSelection: "Azzera selezione",
      selectForCompare: (runId: string) =>
        `Seleziona la run ${runId} per il confronto`,
      diffTitle: "Diff esecuzioni",
      diffEmpty: "Seleziona due esecuzioni per generare il diff.",
      diffNoChanges: "Nessuna differenza rilevata tra le esecuzioni selezionate.",
      diffError: "Impossibile calcolare il diff delle esecuzioni selezionate.",
      diffBaseLabel: "Run di riferimento",
      diffTargetLabel: "Run da confrontare",
      metadataHeading: "Metadati run",
  ...
  en: {
    ...
    history: {
      ...
      emptyHistory: "No executions recorded yet.",
      filterAll: "All",
      filterRunning: "Running",
      filterSuccess: "Completed",
      filterFailure: "Failed",
      filterArchived: "Archived",
      archivedBadge: "Archived",
      compareButton: "Compare",
      compareDisabled: "Pick two runs to compare.",
      compareSelectionLabel: (count: number) =>
        count === 1 ? "1 run selected" : `${count} runs selected`,
      resetSelection: "Clear selection",
      selectForCompare: (runId: string) => `Select run ${runId} for comparison`,
      diffTitle: "Execution diff",
      diffEmpty: "Select two runs to generate the diff.",
      diffNoChanges: "No differences detected between the selected runs.",
      diffError: "Unable to compute a diff for the selected runs.",
      diffBaseLabel: "Reference run",
      diffTargetLabel: "Run to compare",
      metadataHeading: "Run metadata",
